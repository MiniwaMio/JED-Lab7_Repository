...
public class SearchBean {
    ...
    public List<Catalogue> searchCatalogue(String searchTerm) {
        
        List<Catalogue> searchresult = new ArrayList<>();
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT * FROM catalogue WHERE item LIKE ?");
