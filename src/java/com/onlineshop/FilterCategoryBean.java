...
public class FilterCategoryBean {
    ...
    public List<Catalogue> filterCatalogue(int FilterTerm) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT * FROM catalogue WHERE categoryid = ?");
            
            preparedStatement.setInt(1, FilterTerm);
    ...
    public String CatalogueName(int FilterTerm) {
        ...
        try {
            ...
            while(resultset.next()) {
                catalogueName = resultset.getString("description");
